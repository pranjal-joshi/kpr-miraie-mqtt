      ...
      <div class="dial-container" style="--mode-color: ${o}">
        ...
        <div class="dial-center">
          ...
          `:t`
            ...
            <div class="dial-temp">${a||null==i?"--":Number(i).toFixed(1)}<span class="unit">°C</span></div>
